...
Slide MyVoice MakerはPDFスライドと原稿CSV（`index,script`形式）から、**Coqui TTS (XTTS v2)** を使用した自分の声によるAI音声ナレーション付き動画（WebM/MP4）を自動生成し、PPTXや原稿CSVとしても出力できるツールです。フロントエンドはGitHub Pagesで静的配信し、バックエンドはローカルFastAPIで動作します。
...
| 音声合成 | Coqui TTS (XTTS v2) - 自分の声でクローン音声生成 | P1 |
...
3. **音声生成**: サーバー経由でCoqui TTS実行（初回はモデルロードで30-60秒）
...
- **リポジトリ**: https://github.com/J1921604/Slide-MyVoice-Maker
- **機能仕様書**: https://github.com/J1921604/Slide-MyVoice-Maker/blob/main/specs/001-Slide-MyVoice-Maker/spec.md
- **実装計画**: https://github.com/J1921604/Slide-MyVoice-Maker/blob/main/specs/001-Slide-MyVoice-Maker/plan.md
- **タスク一覧**: https://github.com/J1921604/Slide-MyVoice-Maker/blob/main/specs/001-Slide-MyVoice-Maker/tasks.md
- **クイックスタート**: https://github.com/J1921604/Slide-MyVoice-Maker/blob/main/specs/001-Slide-MyVoice-Maker/quickstart.md
